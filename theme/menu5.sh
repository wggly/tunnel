...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/wggly/tunnel/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/wggly/tunnel/main/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/wggly/tunnel/main/izin | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/wggly/tunnel/main/izin | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/wggly/tunnel/main/versions)
